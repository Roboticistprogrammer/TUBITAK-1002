...
```json
{
  "models": [
    ...
    {"name": "Teacher_RS_pt", "path": "Models/teachers/FASDD_RS/best.pt", "type": "teacher", "format": "pt"},
    {"name": "Teacher_UAV_pt", "path": "Models/teachers/FASDD_UAV/best.pt", "type": "teacher", "format": "pt"},
    {"name": "Student_pt", "path": "Models/students/last.pt", "type": "student", "format": "pt"},
    {"name": "Student_onnx", "path": "Models/model.onnx", "type": "student", "format": "onnx"},
